...
--> statement-breakpoint
ALTER TABLE "borrow_records" ADD CONSTRAINT "borrow_records_user_id_todo_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."todo"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
